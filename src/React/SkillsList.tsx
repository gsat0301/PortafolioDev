...
const SkillsList = () => {
  ...
  return (
    <div className="text-left pt-3 md:pt-9">
      <h3 className="text-[#b3b3b3] text-center text-3xl md:text-4xl font-semibold md:mb-6 lg:text-left">
        What I do?
      </h3>
        ...
        {Object.entries(skills).map(([category, items]) => (
          <li key={category} className="w-full">
            <div
              ...
              className="md:w-[400px] w-full bg-[#1414149c] rounded-2xl text-left hover:bg-opacity-80 transition-all border border-[#b3b3b3] cursor-pointer overflow-hidden"
            >
              <div className="flex items-center gap-3 p-4">
                {CategoryIcons[category as keyof typeof CategoryIcons]}
                <div className="flex items-center gap-2 flex-grow justify-between">
                  <div className="min-w-0 max-w-[200px] md:max-w-none overflow-hidden">
                    <span className="block truncate text-[#b3b3b3] text-lg">
                      {category}
                    </span>
                  </div>
                  <svg
